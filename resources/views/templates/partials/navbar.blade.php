    ...
    <div class="d-flex flex-stack flex-grow-1">
        <div class="app-header-logo d-flex align-items-center ps-lg-12" id="kt_app_header_logo">
            ...
            <a href="#" class="app-sidebar-logo">
                <img alt="Logo" src="{{ asset('dist/assets/media/logos/demo39.svg') }}" class="h-25px theme-light-show" />
                <img alt="Logo" src="{{ asset('dist/assets/media/logos/demo39-dark.svg') }}" class="h-25px theme-dark-show" />
            </a>
            <!--end::Logo-->
        </div>
        <!--begin::Navbar-->
            ...
            <div class="app-navbar-item ms-2 ms-lg-6" id="kt_header_user_menu_toggle">
                ...
                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px" data-kt-menu="true">
                    ...
                    <div class="menu-item px-3">
                        <div class="menu-content d-flex align-items-center px-3">
                            ...
                            <div class="symbol symbol-50px me-5">
                                <img alt="Logo" src="{{ asset('dist/assets/media/avatars/300-2.jpg') }}" />
                            </div>
                            <!--end::Avatar-->
                            <!--begin::Username-->
                    ...
                    <div class="menu-item px-5 my-1">
                        <a href="#" class="menu-link px-5">Profil User</a>
                    </div>
                    <!--end::Menu item-->
                    <!--begin::Menu item-->
