...
@php
$title = 'Master Tipe Jawaban';
$preTitle = null;
$currentRouteName = Route::currentRouteName();
@endphp

@section('content')
@include('master.tipe-jawaban.toolbar')
                        ...
                        <div class="table-responsive">
                            <table id="dt_index" class="table table-striped table-bordered gy-5 gs-7 rounded mb-0">
                                <thead>
                                    <tr>
                                        <th scope="col">No.</th>
                                        <th scope="col">Nama Tipe Pertanyaan</th>
...
@include('master.tipe-jawaban.modal')
...
@push('scripts')
    ...
    @include('master.tipe-jawaban.crud-scripts')
@endpush
@endsection