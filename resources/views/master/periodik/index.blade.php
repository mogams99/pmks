...
@php
$title = 'Master Periodik';
$preTitle = null;
$currentRouteName = Route::currentRouteName();
@endphp

@section('content')
@include('master.periodik.toolbar')
...
@push('scripts')
    ...
    @include('master.periodik.crud-scripts')
@endpush
@endsection